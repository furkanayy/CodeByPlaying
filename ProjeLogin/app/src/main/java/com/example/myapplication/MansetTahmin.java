...
public class MansetTahmin extends AppCompatActivity {
    int soruno;
    EditText usertext;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manset);
        ...
        manset = findViewById(R.id.mansetll);
    ...
    private class getResult extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            String url = "http://"+host+":"+port+"/manset/"+number;
        ...
        protected void onPostExecute(String result) {
            ...
            String k = "[4]";
            if(result.equals(x)){
                result = "Bu haber Sağlıkla ilgili";
                manset.setBackgroundResource(R.drawable.saglik);}
            else if(result.equals(y)){
                result = "Bu haber Eğitimle ilgili";
                manset.setBackgroundResource(R.drawable.egitim);}
            else if(result.equals(z)){
                result = "Bu haber Sporla ilgili";
                manset.setBackgroundResource(R.drawable.spor);}
            else if(result.equals(k)){
                result = "Bu haber Magazinle ilgili";
                manset.setBackgroundResource(R.drawable.magazin);}
    ...
    public void onBackPressed() {
        ...
        builder.setPositiveButton("EVET", new DialogInterface.OnClickListener() {
            @Override            public void onClick(DialogInterface dialog, int which) {
                ...
                Intent intent=new Intent(MansetTahmin.this, GamesList.class);
